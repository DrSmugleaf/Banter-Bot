...
module.exports = {
  ...
  dark: {
    normal: 1, fire: 1, water: 1, electric: 1, grass: 1, ice: 1,
    fight: 0.5, poison: 1, ground: 1, flying: 1, psychic: 2, bug: 1,
  ...
  fairy: {
    ...
    fight: 2, poison: 0.5, ground: 1, flying: 1, psychic: 1, bug: 1,
